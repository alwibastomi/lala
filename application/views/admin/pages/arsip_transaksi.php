          ...
          <div class="x_content">
            ...
            <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
              <div class="row"> 
                ...
                <div class="form-group">
                  <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Petugas <span class="required">*</span></label>
                  <div class="col-md-10 col-sm-10 col-xs-12">
                    <input type="text" name="petugas" required="required" class="form-control col-md-7 col-xs-12"  maxlength="255" value="<?= $nama_lengkap ?>" autofocus readonly>
                  </div><br>
                </div>   
                <div class="form-group">
                  <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Nama Peminjam <span class="required">*</span></label>
                  <div class="col-md-10 col-sm-10 col-xs-12">
                    <input type="text" name="namapeminjam" required="required" class="form-control col-md-7 col-xs-12"  maxlength="255"  autofocus>
                  </div><br>
                </div>
                <div class="form-group">
              ...
              <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Batas Waktu <span class="required">*</span></label>
                <div class="col-md-4 col-sm-4 col-xs-12">
                  <input type="date" name="bataswaktu" required="required" class="form-control col-md-7 col-xs-12"  maxlength="255"  autofocus>
                </div>                  
                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Kondisi <span class="required">*</span></label>
                <div class="col-md-2 col-sm-2 col-xs-12">
                 <select class="form-control" name="kondisi" id="klasifikasi" required="required" >
